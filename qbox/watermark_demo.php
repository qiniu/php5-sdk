...
$wmrs  = QBox_WMRS_NewService($client);
...
$uploadToken = QBox_NewAuthPolicy($opts);
list($result, $code, $error) = QBox_RS_PutFile(QBOX_UP_HOST . "/upload", "tblName", $key, 'image/jpg', $path . "/" . $key ,'' , '', $uploadToken);
