...
七牛云存储 PHP SDK 源码地址：<https://github.com/qiniu/php5-sdk> [![Build Status](https://travis-ci.org/rwifeng/php5-sdk.png?branch=b_rwf_travis)](https://travis-ci.org/rwifeng/php5-sdk)
